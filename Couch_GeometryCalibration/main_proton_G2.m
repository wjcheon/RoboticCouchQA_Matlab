...
%% DataStreaming
%      ViconRealTimeSDK_WJ;
%      save('Reference_data_protonG2_150330','BufferForSave');

BufferForSave = load('Reference_data_protonG2_150330')
...
figure(1),hold on;
scatter3(point_transffered(1,:),point_transffered(2,:),point_transffered(3,:),'k*');
...
clear BufferForSave
%        ViconRealTimeSDK_WJ;
%        save('motion_data_protonG2_150330','BufferForSave');
%     BufferForSave = load('motion_data_protonG2.mat')
BufferForSave = load('motion_data_protonG2_150330.mat')
BufferForSave = BufferForSave.BufferForSave;
