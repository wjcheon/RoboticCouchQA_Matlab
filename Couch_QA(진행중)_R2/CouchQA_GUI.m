...
% Last Modified by GUIDE v2.5 12-Feb-2015 13:03:56
...
new_table = xlsread('Xaxis_data.xlsx');
set(handles.uitable1,'Data',new_table)
...
sz = sr+sc;
if (sz == 8)
    set(handles.chb_LoadRelationMatrix,'String','Successful');
    handles.RelationMatrix = stuff;
else
    set(handles.chb_LoadRelationMatrix,'String','Fail')
end
guidata(hObject, handles);
