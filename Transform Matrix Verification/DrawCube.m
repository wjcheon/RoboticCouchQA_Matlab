...
function [] = DrawCube(m,cross,MarkerType,cor)
    ...
    for jj = 1 : size(m,2)
       ...
       hold on; 
       scatter3(Cube_point(1,jj),Cube_point(2,jj),Cube_point(3,jj),MarkerType,'MarkerFaceColor',cor);
%        scatter3(Cube_point(1,jj),Cube_point(2,jj),Cube_point(3,jj), 'MarkerFaceColor',MarkerType);
