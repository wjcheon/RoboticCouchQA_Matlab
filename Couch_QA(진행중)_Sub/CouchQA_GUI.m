function varargout = CouchQA_GUI(varargin)
% COUCHQA_GUI MATLAB code for CouchQA_GUI.fig
%      COUCHQA_GUI, by itself, creates a new COUCHQA_GUI or raises the existing
%      singleton*.
%
%      H = COUCHQA_GUI returns the handle to a new COUCHQA_GUI or the handle to
%      the existing singleton*.
%
%      COUCHQA_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in COUCHQA_GUI.M with the given input arguments.
%
%      COUCHQA_GUI('Property','Value',...) creates a new COUCHQA_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before CouchQA_GUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to CouchQA_GUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help CouchQA_GUI

% Last Modified by GUIDE v2.5 09-Jan-2015 09:57:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @CouchQA_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @CouchQA_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CouchQA_GUI is made visible.
function CouchQA_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to CouchQA_GUI (see VARARGIN)

% Choose default command line output for CouchQA_GUI
...
% UIWAIT makes CouchQA_GUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = CouchQA_GUI_OutputFcn(hObject, eventdata, handles) 
...
function edit_Distancetxt_Callback(hObject, eventdata, handles)
% hObject    handle to edit_Distancetxt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_Distancetxt as text
%        str2double(get(hObject,'String')) returns contents of edit_Distancetxt as a double


% --- Executes during object creation, after setting all properties.
function edit_Distancetxt_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_Distancetxt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in bt_SetRefDistance.
function bt_SetRefDistance_Callback(hObject, eventdata, handles)
% hObject    handle to bt_SetRefDistance (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

TestDistance = str2double(get(handles.edit_Distancetxt,'String'));
handles.TestDistance = TestDistance;
guidata(hObject, handles);
...
Table{1,1} = handles.TestDistance;
Table{1,2} = MeanDistance;
Table{1,3} = (handles.TestDistance-MeanDistance)/handles.TestDistance*100;
...
Information= cell(2,4);
Information{1,1} = date;
Information{1,2} = 'Robotic Couch QA : Distance Report';
Information{2,1} = 'Aimming Accuracy'
Information{2,2} = 'Experimental Data'
Information{2,3} = 'Err(%)'
Information{2,4} = 'Pass/NonPass'
